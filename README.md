...
- `Excel-Files/messy_IMDB_dataset_Raw.xlsx` — original source data, unaltered
- `Excel-Files/messy_IMDB_dataset_Clean.xlsx` — cleaned dataset with **Data Dictionary** tab documenting every transformation
- `Excel-Files/messy_IMDB_dataset_Analysis.xlsx` — pivot tables, density calculations, and charts built from the cleaned data
- `SQL/imdb_main.csv` — cleaned dataset exported for SQL import
- `SQL/imdb.db` — SQLite database used for the analysis
- `SQL/IMDB.sql` — all SQL queries used in the analysis
- `charts/` — exported charts referenced in this README
- `Analysis_Report.md` — formal data analysis report (full midterm deliverable)
...
See also: [GitHub](https://github.com/txaggie7295/auto-loan-default-analysis) (credit risk portfolio project)
